...
def lista_campistas(request):
    ...
    return render(request, 'camping/lista_campistas.html', {'campistas': campistas})
def detalle_campista(request, pk):
    campista = get_object_or_404(Campista, pk=pk)
    return render(request, 'camping/detalle_campista.html', {'campista': campista})
def crear_campista(request):
    if request.method == 'POST':
        ...
        form = CampistaForm()
    return render(request, 'camping/formulario_campista.html', {'form': form})
...
def lista_reservas(request):
    ...
    return render(request, 'camping/lista_reservas.html', {'reservas': reservas})
def detalle_reserva(request, pk):
    reserva = get_object_or_404(Reserva, pk=pk)
    return render(request, 'camping/detalle_reserva.html', {'reserva': reserva})
def crear_reserva(request):
    if request.method == 'POST':
        ...
        form = ReservaForm()
    return render(request, 'camping/formulario_reserva.html', {'form': form})
